...
7. Regra Final de Decisão: Retorne 'Approved' se todos os critérios essenciais estiverem atendidos; 'Rejected' se algo crítico falhar (ex. documento diferente, ilegível, divergência de CNPJ raiz); 'Vencido' se expirado; 'Aguardando Aprovação' em casos duvidosos ou que dependem de revisão humana.
